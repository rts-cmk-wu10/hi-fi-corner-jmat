        ...
        data.forEach(function(produkt) {
            if (produkt.id.toString() === URL.get("produkt")) 
                ...
                BOX.innerHTML = 
                    ...
                    ${produkt.price.discaont !== null ? `<p class="productDetails__price"><span class="productDetails__price--normal">${produkt.price.normal_price}</span>${produkt.price.discaont}</p>` : `<p class="productDetails__price">${produkt.price.normal_price}</p>`}
                ...
                ADDITINAL_TABEL.innerHTML = 
                    ...
                    `<tbody>
                        <tr>
                            <td>Power Output (8/4 Ohm RMS)</td>
